...
@section('content')
    ...
    <div class="container">
        <div class="row center-container mx-auto">
            <div class="col-10 col-md-6 py-4 px-2 px-md-5 border-color-all"
                style="border-radius: 20px;background-color: #F0F5F9;">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="btn-group col-12 mb-3" style="height: 50px;">
                        ...
                        <a href="#" class="btn center-text border-color-all"
                            style="background-color: #DAECF2; color:#2297BE;">Register</a>
                    </div>
                    ...
                    <button type="button" class="btn form-control border-color-all mb-2"><img
                            src="{{ asset('img/googlelogo.jpg') }}" alt="google logo" width="30px" height="30px"
                            style="border-radius: 100%;">&nbsp;&nbsp;&nbsp;Continue with google</button>
