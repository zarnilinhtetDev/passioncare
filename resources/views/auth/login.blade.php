            ...
            <form id="login" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group mt-1">
                        ...
                        <input type="phone" class="form-control border-start-0 border-color @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        @error('email')
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group mt-1">
                        ...
                        <span class="input-group-text border-color" id="eye" style="background-color: white !important; cursor:pointer;"><i class="fa-solid fa-eye" id="eye-open"></i></span>
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group" style="display: flex; align-items: center; justify-content:space-between;">
                    ...
                    <div class="" style="text-align:right;">
                        <a href="" class="text-danger " id="forget_password">Forget Password?</a>
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('register') }}" id="register" style="display:none;">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group mt-1">
                        ...
                        <input type="text" class="form-control border-start-0 border-color @error('name') is-invalid @enderror" name="name" placeholder="Mg xxxxxxxxxx" aria-label="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group mt-1">
                        <span class="input-group-text border-color"><i class="fa-solid fa-square-phone"></i></span>
                        <input type="phone" class="form-control border-start-0 border-color @error('email') is-invalid @enderror" aria-label="email" name="email" value="{{ old('email') }}" required autocomplete="email">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
