                    ...
                    <table class="table table-bordered " id="example-1">
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                @else
                                <td>{{$h_ongoing->ticket->patient_complaint}}</td>
                                <td><a href="{{url("hospital_ongoing_complete",$h_ongoing->id)}}" class="btn btn-primary">Done</a></td>
                                @endif
                            </tr>
                            @endif
                            @endforeach
