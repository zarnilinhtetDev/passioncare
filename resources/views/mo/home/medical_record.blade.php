                    ...
                    <table class="table table-bordered " id="example-1">
                        <thead class="thead">
                            <tr>
                                ...
                                <th style="background-color: #FAF9F6" scope="col">Date</th>
                                ...
                                <th style="background-color: #FAF9F6" scope="col">Patient ID</th>
                                <th style="background-color: #FAF9F6" scope="col">Consultion</th>
                            </tr>
                        </thead>
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td>{{ $medical_record->hospital_names }}</td>
                                <td>{{ $medical_record->doctor_name }} </td>
                                <td>{{ $medical_record->patient_name }} </td>
                                <td>ERS - {{ $medical_record->patient_id }} </td>
                                <!-- <td>{{--$ticket->updated_at->format("d-m-Y")--}}</td> -->
                                <td><a href="{{url("health_record",$medical_record->ticket_id)}}" class="btn btn-primary">Record</a></td>
                            </tr>
                            @endforeach
