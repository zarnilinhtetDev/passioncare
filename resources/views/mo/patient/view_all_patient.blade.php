                    ...
                    <table class="table table-bordered " id="example-1">
                        <thead class="thead">
                            <tr>
                                ...
                                <th style="background-color: #FAF9F6" scope="col">Create Ticket</th>
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="{{url('/reason')}}" class="btn btn-info mb-2">Doctor Conservation</a></td>
                                <td class="text-center"><a href="#" class="btn btn-primary mb-2">Create Ticket</a></td>
