    ...
    <div id="wrapper" style="background-color: #F0F5F9; font-family: Arial, Helvetica, sans-serif;">
        ...
        <section class="container-fluid mt-lg-5">
            <div class="row d-flex align-items-center justify-content-center pt-md-5 mt-xl-2 mb-lg-3 mb-xl-0">
                <div class="card shadow col-md-11 col-lg-10 mx-auto px-0 px-lg-2 pb-md-4 mb-4 mb-md-0">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        <div class="form-group col-4 d-flex align-items-center gap-2">
                                            <input type="radio" class="m-0 p-0" id="male" name="gender" value="Male">
                                            <label for="male" class="m-0 p-0">Male</label>
                                        </div>
                                        <div class="form-group col-4 d-flex align-items-center gap-2">
                                            <input type="radio" class="m-0 p-0" id="female" name="gender" value="Female">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="height" name="height" placeholder=" Enter Patient NRC Number" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="blood_type" class="">Blood Type</label>
                                        <input type="text" class="form-control" id="blood_type" name="blood_type" placeholder=" Enter Blood Type" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="Enter Emergency contact Name" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="contact_number" class="">Contact Number</label>
                                        <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="Enter Emergency Contact Number" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="contact_address">Address</label>
                                        <textarea name="contact_address" id="contact_address" class="form-control" rows="5"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Enter Insurance Company Name" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="company_contact_number" class="">Company Contact Number</label>
                                        <input type="text" class="form-control" id="company_contact_number" name="company_contact_number" placeholder="Enter Company Contact Number" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="medical_plan" name="medical_plan" placeholder=" Enter Medical Plan" required>
                                    </div>
                                </div>
                            </div>

                            <div class="row mt-5 d-flex justify-content-end">
                                <div class="col-12 col-sm-4 col-lg-3 mb-5 mb-md-0 d-flex align-items-center">
                                    <div class="col-6 d-flex justify-content-center">
                                        <a href="{{route('mo_home')}}" class="btn btn-primary px-5 py-3">Back</a>
                                    </div>
                                    <div class="col-6 d-flex justify-content-center">
                                        <button type="submit" class="btn btn-primary px-5 py-3">Save</button>
                                    </div>
                                </div>
                            </div>
                        </form>
