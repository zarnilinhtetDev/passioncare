                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" id="hospital_phone_number" name="hospital_phone_number" placeholder="Enter Phone Number" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <button type="button" id="copyLinkBtn" class="btn btn-warning mt-2"> <i class="fa-solid fa-paperclip"></i></button>
