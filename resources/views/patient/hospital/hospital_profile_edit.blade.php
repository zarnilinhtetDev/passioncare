                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="card shadow col-xl-10 mx-auto px-0 px-lg-2 pb-md-4 mb-5 mb-sm-0">
                            <div class="card-body">
                                <form action="{{ route('hospitalUpdate', $hospital->id) }}" method="POST" class="mt-5" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="hidden" name="old_profile" value="{{$hospital->image}}">
                                            @error('new_profile')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <div class="">
                                                <a href="{{ route('hospitalProfile') }}" class="btn btn-primary px-5 py-3" style="border-radius: 10px;">Back</a>
                                            </div>
                                            <div class="ms-5">
