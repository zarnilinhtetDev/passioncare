                            ...
                            <div class="col-12 col-sm-6 py-4 ">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 mt-3">
                                        ...
                                        <input type="hidden" class="form-control fs-4" name="old_document" id="old_document" value="{{$medical_history->document ?? ""}}">
                                    </div>
                                </div>
                        ...
                        <div class="col-12 mt-5">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="hidden" name="old_laboratory_tests" value="{{$diagnosis->laboratory_tests ?? ""}}">
                                </div>
                            </div>
