                ...
                <div style="margin-top: 8%">
                    ...
                    <section class="card shadow">
                        <div class="row col-md-12 justify-content-center my-3">
                            <form class="form-group" action="{{ url('profile_update', Auth::user()->id) }}"
                                method="post">
                                @csrf
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ $patient->name ?? Auth::user()->name }}">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="blood_type" name="blood_type"
                                        value="{{ $initial->blood_type ?? '' }}">
                                </div>
                                <div class="col-md-4 mt-3">
                                    <label for="name">City</label>
                                    <input type="text" class="form-control" id="city" name="city"
                                        value="{{ $p_address->city ?? '' }}">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="contact_number"
                                        name="contact_number" value="{{ $emergency->contact_number ?? '' }}">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="company_contact_number"
                                        name="company_contact_number"
                                        value="{{ $insurance->company_contact_number ?? '' }}">
                                </div>


                                <div class="col-md-3">
                                    <label for="name">Medical Plan</label>
                                    <input type="text" class="form-control" id="medical_plan" name="medical_plan"
                                        value="{{ $insurance->medical_plan ?? '' }}"></inpu>
                                </div>
                                <div class="col-md-3">
